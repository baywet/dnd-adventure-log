...
1. Dotnet SDK 10 `sudo winget install Microsoft.Dotnet.SDK.10`.
...
1. An Azure AI Foundry deployment with the following models `gpt-5.2`, `gpt-4o-mini-transcribe`, `gpt-image-1.5` and `sora-2`.
